...
if($user->casoDeUso != null && empty($user->subDominio)){
	echo '<script>window.location.href="setup3.html"</script>';
} elseif ($user->casoDeUso != null && !empty($user->subDominio)) {
